...
BEGIN TRY
    ...
    USING (VALUES 
        ...
        (1,  1,  '2026-08-14 12:00:00', '2026-08-14 18:00:00'),
        (2,  1,  '2026-08-15 12:00:00', '2026-08-15 16:00:00'),

        -- Sale 2: Saturday Aug 15 & Sunday Aug 16, 2026
        (3,  2,  '2026-08-15 11:00:00', '2026-08-15 19:00:00'),
        (4,  2,  '2026-08-16 12:00:00', '2026-08-16 17:00:00'),

        -- Sale 3: Saturday Aug 15, 2026 (Single day)
        (5,  3,  '2026-08-15 12:30:00', '2026-08-15 20:00:00'),

        -- Sale 4: Friday Aug 21 & Saturday Aug 22, 2026
        (6,  4,  '2026-08-21 13:00:00', '2026-08-21 21:00:00'),
        (7,  4,  '2026-08-22 13:00:00', '2026-08-22 18:00:00'),

        -- Sale 5: Saturday Aug 22 & Sunday Aug 23, 2026
        (8,  5,  '2026-08-22 12:00:00', '2026-08-22 20:00:00'),
        (9,  5,  '2026-08-23 13:00:00', '2026-08-23 18:00:00'),

        -- Sale 6: Saturday Aug 22, 2026 (Single day)
        (10, 6,  '2026-08-22 11:00:00', '2026-08-22 17:00:00'),

        -- Sale 7: Friday Aug 28 & Saturday Aug 29, 2026
        (11, 7,  '2026-08-28 14:00:00', '2026-08-28 22:00:00'),
        (12, 7,  '2026-08-29 13:00:00', '2026-08-29 19:00:00'),

        -- Sale 8: Saturday Aug 29 & Sunday Aug 30, 2026
        (13, 8,  '2026-08-29 11:30:00', '2026-08-29 18:00:00'),
        (14, 8,  '2026-08-30 12:00:00', '2026-08-30 16:00:00'),

        -- Sale 9: Saturday Aug 29, 2026 (Single day)
        (15, 9,  '2026-08-29 12:00:00', '2026-08-29 19:00:00'),

        -- Sale 10: Friday Sep 4 & Saturday Sep 5, 2026
        (16, 10, '2026-09-04 12:00:00', '2026-09-04 18:00:00'),
        (17, 10, '2026-09-05 12:00:00', '2026-09-05 16:00:00')
